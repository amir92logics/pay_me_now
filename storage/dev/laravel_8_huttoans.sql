...
--
-- Host: localhost:3306
-- Generation Time: Jul 30, 2022 at 10:21 PM
...
(1, 'Super Admin', 'admin@admin.com', 'admin', NULL, '610f07de2e50e1628375006.png', '$2y$10$kHgHAzM4XU4Fk0oE.YbysOr8Y6s4JG00F1PgbpiRAPUNqVu7dDXBK', NULL, '2021-08-08 02:53:26');
...
(1, 1, 'New member registered', 0, '/admin/user/detail/1', '2022-07-23 17:19:38', '2022-07-23 17:19:38'),
(2, 2, 'New member registered', 0, '/admin/user/detail/2', '2022-07-24 16:12:02', '2022-07-24 16:12:02'),
(3, 3, 'New member registered', 0, '/admin/user/detail/3', '2022-07-25 08:21:44', '2022-07-25 08:21:44'),
(4, 3, 'Deposit request from hagepasu', 1, '/admin/deposit/details/9', '2022-07-25 09:00:05', '2022-07-30 11:04:23'),
(5, 2, 'Deposit request from banahijere', 0, '/admin/deposit/details/10', '2022-07-30 16:00:12', '2022-07-30 16:00:12');
...
CREATE TABLE `atms` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `embeded` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `atms` (`id`, `name`, `address`, `latitude`, `longitude`, `status`, `embeded`, `created_at`, `updated_at`) VALUES
(1, 'HBL ATM', 'HBL ATM, I 10 Markaz I-10, Islamabad', 33.6480498000, 73.0377401000, 1, NULL, '2022-07-30 11:49:09', '2022-07-30 15:03:50'),
(2, 'Iliana Leon', 'Deserunt labore recu', 33.6535115000, 73.0490536000, 1, NULL, '2022-07-30 12:17:38', '2022-07-30 12:17:38'),
(3, 'Neville Rios', 'Quos quis omnis quia', 0.0000000000, 0.0000000000, 1, NULL, '2022-07-30 12:21:14', '2022-07-30 12:21:14');
...
CREATE TABLE `cryptotrxes` (
  ...
  `explorer_url` text COLLATE utf8mb4_unicode_ci,
  `wallet_id` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `currencies` (`id`, `name`, `symbol`, `icon`, `apipass`, `apikey`, `price`, `fee`, `swap`, `min`, `max`, `image`, `is_coin`, `canswap`, `canwallet`, `status`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Ethereum', 'ETH', 'sign-eth-alt', NULL, NULL, '1888.77', '1', '10', 1, 1000000000, 'eth.png', 1, 1, 1, 1, '2021-01-15 05:14:00', '2018-02-15 05:36:57', '2021-08-09 14:45:03'),
(2, 'Bitcoin', 'BTC', 'sign-eth-alt', NULL, NULL, '31689', '1', '8', 10, 2147483647, 'btc.svg', 1, 1, 1, 1, '2021-01-15 05:14:00', '2018-02-15 05:36:57', '2021-08-11 19:37:20'),
(3, 'Bitcoin Cash', 'BCH', 'sign-bch-alt', NULL, NULL, '436.22', '1', '7', 100, 1000, 'bch.png', 1, 1, 1, 1, '2021-01-15 05:13:29', '2018-02-15 05:36:57', '2021-07-19 07:11:20'),
(4, 'Litecoin', 'LTC', 'sign-ltc-alt', NULL, NULL, '118.15', '1', '8', 100000, 100000, 'ltc.png', 1, 1, 1, 1, '2021-01-15 05:13:25', '2018-02-15 05:36:57', '2021-07-19 07:11:20'),
(5, 'Dashcoin', 'DASH', NULL, NULL, NULL, '114.24', '1', '5', 100000, 100000, 'dash.png', 1, 1, 1, 1, NULL, '2021-01-22 02:39:38', '2021-07-19 07:11:20'),
(6, 'Test Coin', 'TCN', 'sign-php-alt', NULL, NULL, '1', '1', '10', 1, 10, 'busd.png', 1, 1, 1, 1, '2021-01-15 05:13:17', '2018-10-22 11:49:14', '2021-03-30 22:44:31'),
(7, 'Binance Coin', 'BNB', 'sign-php-alt', NULL, NULL, '1', '1', '10', 1, 10, 'bnb.png', 1, 1, 1, 1, '2021-01-15 05:13:17', '2018-10-22 11:49:14', '2021-03-30 22:44:31'),
(11, 'USD Teter', 'USDTERC20', 'sign-php-alt', NULL, NULL, '1', '1', '8', 100, 1000, 'usdt.png', 1, 1, 1, 1, '2021-01-15 05:13:17', '2018-10-22 11:49:14', '2021-07-19 05:39:08'),
(118, 'Dogecoin', 'DOGE', NULL, NULL, NULL, '0.181255', '1', NULL, 100, 1000, 'doge.svg', 1, 1, 1, 1, NULL, '2021-01-22 02:39:38', '2021-07-19 07:11:20');

-- --------------------------------------------------------

--
-- Table structure for table `dashboard_contents`
--
...
CREATE TABLE `dashboard_contents` (
  ...
  `data_text` text COLLATE utf8mb4_unicode_ci,
  `data_text2` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `dashboard_contents`
--

INSERT INTO `dashboard_contents` (`id`, `data_key`, `data_type`, `data_text`, `data_text2`, `created_at`, `updated_at`) VALUES
(1, 'dashboard.footer', 'content.line.line1', 'Copyright © 2022 All Right Reserved', NULL, '2022-07-24 18:19:01', '2022-07-24 18:19:01'),
(2, 'dashboard.footer', 'content.line.line2', 'Member Line 2 Text', NULL, '2022-07-24 18:19:01', '2022-07-24 18:19:01'),
(3, 'dashboard.footer', 'element.textlink', 'Privacy & Security', 'https://google.com', '2022-07-24 18:19:01', '2022-07-24 18:19:01'),
(4, 'dashboard.footer', 'element.textlink', 'Identity Theft', 'https://google.com', '2022-07-24 18:19:01', '2022-07-24 18:19:01');
...
INSERT INTO `dashboard_slides` (`id`, `position`, `path`, `created_at`, `updated_at`) VALUES
(1, 1, 'slide1.jpg', '2022-07-24 18:19:00', '2022-07-24 18:19:00'),
(2, 2, 'slide2.jpg', '2022-07-24 18:19:00', '2022-07-24 18:19:00'),
(3, 3, 'slide3.jpg', '2022-07-24 18:19:00', '2022-07-24 18:19:00'),
(4, 4, 'slide4.jpg', '2022-07-24 18:19:00', '2022-07-24 18:19:00');
...
(7, 3, 109, '500.00000000', 'USD', '30.00000000', '1.00000000', '530.00000000', NULL, '0', '', 'M8AV97', 0, 0, 0, NULL, '2022-07-25 08:47:27', '2022-07-25 08:47:27'),
(8, 3, 114, '500.00000000', 'EUR', '85.00000000', '1.43000000', '836.55000000', NULL, '0', 'cs_test_a1ProhhCnpXrnNcwi1IULWggwCWpZMbw4DippPdVecCOwhVccQDzd8A1gc', '1R5NNE', 0, 0, 0, NULL, '2022-07-25 08:50:47', '2022-07-25 08:51:03'),
(9, 3, 1001, '500.00000000', 'EUR', '105.00000000', '1.43000000', '865.15000000', '{\"front_side_of_check\":{\"field_name\":\"2022\\/07\\/25\\/62de77b4a2a2e1658746804.png\",\"type\":\"file\"},\"back_side_of_check\":{\"field_name\":\"2022\\/07\\/25\\/62de77b5965b31658746805.jpg\",\"type\":\"file\"}}', '0', '', 'O39VPH', 0, 1, 0, NULL, '2022-07-25 08:59:18', '2022-07-25 09:00:57'),
(10, 2, 1000, '200.00000000', 'USD', '110.00000000', '1.00000000', '310.00000000', '{\"front_side_of_check\":{\"field_name\":\"2022\\/07\\/30\\/62e571aaf211a1659204010.png\",\"type\":\"file\"},\"back_side_of_check\":{\"field_name\":\"2022\\/07\\/30\\/62e571abdd5c81659204011.jpeg\",\"type\":\"file\"}}', '0', '', 'GJADFW', 0, 1, 0, NULL, '2022-07-30 15:58:54', '2022-07-30 16:03:00');
...
(8, 108, 'VoguePay', 'Voguepay', '5f6f1d5951a111601117529.jpg', 0, '{\"merchant_id\":{\"title\":\"MERCHANT ID\",\"global\":true,\"value\":\"demo\"}}', '{\"USD\":\"USD\",\"GBP\":\"GBP\",\"EUR\":\"EUR\",\"GHS\":\"GHS\",\"NGN\":\"NGN\",\"ZAR\":\"ZAR\"}', 0, NULL, NULL, NULL, '2019-09-14 13:14:22', '2022-07-23 05:02:43'),
(9, 109, 'Flutterwave', 'Flutterwave', '5f6f1b9e4bb961601117086.jpg', 1, '{\"public_key\":{\"title\":\"Public Key\",\"global\":true,\"value\":\"FLWPUBK_TEST-8e389caf13f41da9e78839ce494fefa5-X\"},\"secret_key\":{\"title\":\"Secret Key\",\"global\":true,\"value\":\"FLWSECK_TEST-057ead6e587b49df44d049740f28f12a-X\"},\"encryption_key\":{\"title\":\"Encryption Key\",\"global\":true,\"value\":\"FLWSECK_TESTed1ae5be0983\"}}', '{\"BIF\":\"BIF\",\"CAD\":\"CAD\",\"CDF\":\"CDF\",\"CVE\":\"CVE\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"GHS\":\"GHS\",\"GMD\":\"GMD\",\"GNF\":\"GNF\",\"KES\":\"KES\",\"LRD\":\"LRD\",\"MWK\":\"MWK\",\"MZN\":\"MZN\",\"NGN\":\"NGN\",\"RWF\":\"RWF\",\"SLL\":\"SLL\",\"STD\":\"STD\",\"TZS\":\"TZS\",\"UGX\":\"UGX\",\"USD\":\"USD\",\"XAF\":\"XAF\",\"XOF\":\"XOF\",\"ZMK\":\"ZMK\",\"ZMW\":\"ZMW\",\"ZWD\":\"ZWD\"}', 0, NULL, NULL, NULL, '2019-09-14 13:14:22', '2022-07-25 12:29:29'),
...
(14, 502, 'Block.io', 'Blockio', '5f6f19432bedf1601116483.jpg', 1, '{\"api_key\":{\"title\":\"API Key\",\"global\":false,\"value\":\"1658-8015-2e5e-9afb\"},\"api_pin\":{\"title\":\"API PIN\",\"global\":true,\"value\":\"75757575\"}}', '{\"BTC\":\"BTC\",\"LTC\":\"LTC\"}', 1, '{\"cron\":{\"title\": \"Cron URL\",\"value\":\"ipn.Blockio\"}}', NULL, NULL, '2019-09-14 13:14:22', '2022-07-23 05:02:50'),
...
(35, 1000, 'Bank Transfer', 'bank_transfer', '62deccba3c14e1658768570.png', 1, '[]', '[]', 0, NULL, 'Please Upload Front Side and Back Side of Deposit Check', '{\"front_side_of_check\":{\"field_name\":\"front_side_of_check\",\"field_level\":\"Front Side of Check\",\"type\":\"file\",\"validation\":\"required\"},\"back_side_of_check\":{\"field_name\":\"back_side_of_check\",\"field_level\":\"Back Side of Check\",\"type\":\"file\",\"validation\":\"required\"}}', '2022-07-25 08:58:47', '2022-07-25 15:04:17');
...
(9, 'Stripe Checkout - EUR', 'EUR', 'E', 114, 'StripeV3', '200.00000000', '20000.00000000', '3.00', '70.00000000', '1.43000000', NULL, '{\"secret_key\":\"sk_test_51I6GGiCGv1sRiQlEi5v1or9eR0HVbuzdMd2rW4n3DxC8UKfz66R4X6n4yYkzvI2LeAIuRU9H99ZpY7XCNFC9xMs500vBjZGkKG\",\"publishable_key\":\"pk_test_51I6GGiCGv1sRiQlEOisPKrjBqQqqcFsw8mXNaZ2H2baN6R01NulFS7dKFji1NRRxuchoUTEDdB7ujKcyKYSVc0z500eth7otOM\",\"end_point\":\"whsec_lUmit1gtxwKTveLnSe88xCSDdnPOt8g5\"}', '2022-07-25 08:50:16', '2022-07-25 08:50:16'),
(10, 'Bank Transfer', 'USD', '', 1000, 'bank_transfer', '100.00000000', '10000.00000000', '5.00', '100.00000000', '1.00000000', '62deccba3c14e1658768570.png', '{\"front_side_of_check\":{\"field_name\":\"front_side_of_check\",\"field_level\":\"Front Side of Check\",\"type\":\"file\",\"validation\":\"required\"},\"back_side_of_check\":{\"field_name\":\"back_side_of_check\",\"field_level\":\"Back Side of Check\",\"type\":\"file\",\"validation\":\"required\"}}', '2022-07-25 08:58:48', '2022-07-25 15:04:17'),
(11, 'Test Flutterwave - USD', 'USD', '$', 109, 'Flutterwave', '10.00000000', '1000.00000000', '2.00', '20.00000000', '1.00000000', NULL, '{\"public_key\":\"FLWPUBK_TEST-8e389caf13f41da9e78839ce494fefa5-X\",\"secret_key\":\"FLWSECK_TEST-057ead6e587b49df44d049740f28f12a-X\",\"encryption_key\":\"FLWSECK_TESTed1ae5be0983\"}', '2022-07-25 12:29:30', '2022-07-25 12:29:30');
...
INSERT INTO `general_settings` (`id`, `sitename`, `cur_text`, `cur_sym`, `email_from`, `email_template`, `sms_api`, `base_color`, `secondary_color`, `mail_config`, `sms_config`, `ev`, `en`, `sv`, `sn`, `force_ssl`, `agree`, `registration`, `active_template`, `sys_version`, `swap`, `cardfee`, `transferfee`, `news`, `google_map_api_key`, `created_at`, `updated_at`) VALUES
(1, 'Bankly Fintech', 'USD', '$', 'do-not-reply@asapcodes.com', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello {{fullname}} ({{username}})</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\">{{message}}</td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">Website Name</a> . All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'hi {{name}}, {{message}}', NULL, '15864c', '{\"name\":\"smtp\",\"host\":\"smtp.mailtrap.io\",\"port\":\"2525\",\"enc\":\"tls\",\"username\":\"3586b3c4e07520\",\"password\":\"9f1d0e1ec40225\"}', '{\"clickatell_api_key\":\"----------------------------\",\"infobip_username\":\"--------------\",\"infobip_password\":\"----------------------\",\"message_bird_api_key\":\"-------------------\",\"account_sid\":\"AC67afdacf2dacff5f163134883db92c24\",\"auth_token\":\"77726b242830fb28f52fb08c648dd7a6\",\"from\":\"+17739011523\",\"apiv2_key\":\"dfsfgdfgh\",\"name\":\"clickatell\"}', 0, 0, 0, 0, 0, 1, 1, 'basic', NULL, 'dsdsgsd', 5, 1, 'Here is the demo news', 'AIzaSyCoRyJoj3pX6Afgi8KR2ftKibz4j3rFp98', NULL, '2022-07-30 19:54:33');
...
(1, 'Voters Card', 0, '2021-08-11 11:48:24', '2021-08-11 11:54:00'),
...
(16, 16, 2, '300', '9', '309', NULL, NULL, NULL, 3, 'WZOWA1', '2022-07-24 19:43:38', '2022-07-24 22:43:38', '2023-04-24 22:31:42', '9'),
(17, 16, 2, '990', '29.7', '1019.7', NULL, NULL, NULL, 1, 'CW61BS', '2022-07-24 20:13:44', '2022-07-24 23:13:44', '2023-02-24 22:44:25', '7');

-- --------------------------------------------------------

--
-- Table structure for table `loan_attributes`
--

CREATE TABLE `loan_attributes` (
...
--
-- Dumping data for table `loan_attributes`
--

INSERT INTO `loan_attributes` (`id`, `data_key`, `data_type`, `data_value`, `loan_id`, `created_at`, `updated_at`) VALUES
(1, 'attachment', 'image', '165869186532.jpg', 17, '2022-07-24 17:44:25', '2022-07-24 17:44:25'),
(2, 'attachment', 'image', '165869186535.png', 17, '2022-07-24 17:44:25', '2022-07-24 17:44:25');
...
(16, 'Test Loan Plan', '3', '1', 200, 5000, '12', 1, '2022-07-24 16:18:04', '2022-07-24 16:18:04');
...
(35, '2022_07_22_205244_create_dashboard_slides_table', 17),
(36, '2022_07_23_110536_create_dashboard_contents_table', 17),
(37, '2022_07_25_203204_create_sub_saving_accounts_table', 18),
(38, '2022_07_26_145345_create_sub_saving_account_logs_table', 18),
(41, '2022_07_28_233235_create_atms_table', 19);
...
--
-- Table structure for table `sub_saving_accounts`
--

CREATE TABLE `sub_saving_accounts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `sub_saving_accounts`
--

INSERT INTO `sub_saving_accounts` (`id`, `name`, `amount`, `status`, `enabled_at`, `user_id`, `created_at`, `updated_at`) VALUES
(2, 'Test 1', 50550, 1, NULL, 2, '2022-07-26 12:08:39', '2022-07-28 17:08:43'),
(3, 'Test 2', 0, 1, NULL, 2, '2022-07-28 11:04:02', '2022-07-28 11:04:02'),
(4, 'Test 3', 8990, 1, NULL, 2, '2022-07-28 11:04:45', '2022-07-28 11:04:45'),
(5, 'test 4', 10, 1, NULL, 2, '2022-07-28 11:05:34', '2022-07-28 11:05:34'),
(6, 'Test 5', 1, 1, NULL, 2, '2022-07-28 11:06:37', '2022-07-28 11:06:37'),
(9, 'Last Account', 19500, 1, NULL, 2, '2022-07-28 11:20:08', '2022-07-28 11:20:08'),
(10, 'For Education', 1279, 0, NULL, 3, '2022-07-28 17:10:54', '2022-07-28 18:14:09');

-- --------------------------------------------------------

--
-- Table structure for table `sub_saving_account_logs`
--

CREATE TABLE `sub_saving_account_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `trx` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trx_type` tinyint(1) NOT NULL DEFAULT '1',
  `details` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` bigint(20) UNSIGNED DEFAULT NULL,
  `charge` bigint(20) UNSIGNED DEFAULT NULL,
  `initial_balance` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `sub_saving_account_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `sub_saving_account_logs`
--

INSERT INTO `sub_saving_account_logs` (`id`, `trx`, `trx_type`, `details`, `amount`, `charge`, `initial_balance`, `user_id`, `sub_saving_account_id`, `created_at`, `updated_at`) VALUES
(1, 'SSA3A75CH', 1, 'Account Created', 50000, NULL, 0, 2, 2, '2022-07-26 12:08:39', '2022-07-26 12:08:39'),
(2, 'SSA7K187D', 1, 'Account Created', 8990, NULL, 0, 2, 4, '2022-07-28 11:04:46', '2022-07-28 11:04:46'),
(3, 'SSAR9APCG', 1, 'Account Created', 10, NULL, 0, 2, 5, '2022-07-28 11:05:34', '2022-07-28 11:05:34'),
(4, 'SSAM5M2VB', 1, 'Account Created', 1, NULL, 0, 2, 6, '2022-07-28 11:06:38', '2022-07-28 11:06:38'),
(7, 'SSATENC49', 1, 'Account Created', 19500, NULL, 0, 2, 9, '2022-07-28 11:20:08', '2022-07-28 11:20:08'),
(8, 'SSAC4K3TKT', 1, NULL, 55000, NULL, 50000, 2, 2, '2022-07-28 17:08:43', '2022-07-28 17:08:43'),
(9, 'SSACF2S6D3', 1, 'Account Created', 12180, NULL, 0, 3, 10, '2022-07-28 17:10:54', '2022-07-28 17:10:54'),
(10, 'SSACJ4UEXC', 1, NULL, 800, NULL, 12180, 3, 10, '2022-07-28 17:13:12', '2022-07-28 17:13:12'),
(11, 'SSADBSP5Q2', 0, NULL, 2100, NULL, 12188, 3, 10, '2022-07-28 17:36:22', '2022-07-28 17:36:22'),
(12, 'SSADZ7TD1A', 0, NULL, 9019, NULL, 10088, 3, 10, '2022-07-28 17:38:40', '2022-07-28 17:38:40'),
(13, 'SSACQHAVVS', 1, NULL, 210, NULL, 1069, 3, 10, '2022-07-28 17:42:55', '2022-07-28 17:42:55');
...
(41, 3, '500.00000000', '105.00000000', '500.00000000', '+', 'O39VPH', 'Deposit Via KmAs Transfer', '2022-07-25 09:00:57', '2022-07-25 09:00:57'),
(42, 2, '200.00000000', '110.00000000', '250.00000000', '+', 'GJADFW', 'Deposit Via Bank Transfer', '2022-07-30 16:03:01', '2022-07-30 16:03:01');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `account_number`, `email`, `country_code`, `mobile`, `ref_by`, `balance`, `password`, `image`, `address`, `status`, `ev`, `sv`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `kyc`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Illana', 'Pace', 'cijira', '8922983490', 'vymadejuvy@mailinator.com', 'ER', '291Omnis eum dolorem ut', 0, '0.00000000', '$2y$10$/sZq.7Qbg5KINReJe6vn0.tCT0Vs2wF7W8Lo65skyuA.CajxBctte', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Eritrea\",\"city\":\"\"}', 1, 1, 1, NULL, NULL, 0, 1, NULL, 0, NULL, '2022-07-23 17:19:38', '2022-07-23 17:19:38'),
(2, 'Sandra', 'Coffey', 'banahijere', '9133397570', 'aamirsohailkmas@gmail.com', 'MV', '+1 234 5678', 0, '250.00000000', '$2y$10$veTLYsCB36sx3SBzxdI/4uZy3NkhFGjm.geFY2t/RTTpM1mFu/yLS', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Maldives\",\"city\":\"\"}', 1, 1, 1, NULL, NULL, 0, 1, NULL, 0, 'NMLyKHq5yxMfE9WXhJiLsZXJjQvJ7Uet7ohemoRGnBLEUj1k2H2K9QGS5ZZp', '2022-07-24 16:12:02', '2022-07-30 16:41:05'),
(3, 'Berk', 'Barker', 'hagepasu', '3268480931', 'jolup@mailinator.com', 'VC', '1784Fugiat at obcaecati', 0, '479.29000000', '$2y$10$DAfUIkN9ZA2KcJpB40s6/elNUgHC6N5jLXjXxXAFkp9b8aWX6BHjS', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Saint Vincent and the Grenadines\",\"city\":\"\"}', 1, 1, 1, NULL, NULL, 0, 1, NULL, 0, NULL, '2022-07-25 08:21:44', '2022-07-28 17:42:55');
...
(1, 1, '::1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-07-23 17:19:39', '2022-07-23 17:19:39'),
(2, 2, '::1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-07-24 16:12:02', '2022-07-24 16:12:02'),
(3, 3, '::1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-07-25 08:21:44', '2022-07-25 08:21:44'),
(4, 2, '::1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-07-25 12:30:48', '2022-07-25 12:30:48');
...
(2, 'KmAs Transfer', '62de73bd17ced1658745789.png', '100.00000000', '10000.00000000', '8', '50.00000000', '1.00000000', '2.00', 'USD', '{\"front_side_of_check\":{\"field_name\":\"front_side_of_check\",\"field_level\":\"Front Side of Check\",\"type\":\"file\",\"validation\":\"required\"},\"back_side_of_check\":{\"field_name\":\"back_side_of_check\",\"field_level\":\"Back Side of Check\",\"type\":\"file\",\"validation\":\"required\"}}', 'Withdraw Instruction Here', 1, '2022-07-25 08:43:10', '2022-07-25 08:43:10');
...
--
-- Indexes for table `dashboard_contents`
--
...
--
-- Indexes for table `loan_attributes`
--
ALTER TABLE `loan_attributes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `loan_attributes_loan_plan_id_foreign` (`loan_id`);
...
--
-- Indexes for table `sub_saving_accounts`
--
ALTER TABLE `sub_saving_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sub_saving_accounts_user_id_foreign` (`user_id`);

--
-- Indexes for table `sub_saving_account_logs`
--
ALTER TABLE `sub_saving_account_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sub_saving_account_logs_user_id_foreign` (`user_id`),
  ADD KEY `sub_saving_account_logs_sub_saving_account_id_foreign` (`sub_saving_account_id`);
...
--
-- AUTO_INCREMENT for table `dashboard_contents`
--
ALTER TABLE `dashboard_contents`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `loan_attributes`
--
ALTER TABLE `loan_attributes`
...
--
-- AUTO_INCREMENT for table `sub_saving_accounts`
--
ALTER TABLE `sub_saving_accounts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `sub_saving_account_logs`
--
ALTER TABLE `sub_saving_account_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- Constraints for table `loan_attributes`
--
ALTER TABLE `loan_attributes`
  ADD CONSTRAINT `loan_attributes_loan_id_foreign` FOREIGN KEY (`loan_id`) REFERENCES `loans` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sub_saving_accounts`
--
ALTER TABLE `sub_saving_accounts`
  ADD CONSTRAINT `sub_saving_accounts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `sub_saving_account_logs`
--
ALTER TABLE `sub_saving_account_logs`
  ADD CONSTRAINT `sub_saving_account_logs_sub_saving_account_id_foreign` FOREIGN KEY (`sub_saving_account_id`) REFERENCES `sub_saving_accounts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `sub_saving_account_logs_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
