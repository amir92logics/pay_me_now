...
class LoanController extends Controller
{
    ...
    public function getPlanInfos(Request $request)
    {
        $inputs = LoanPlan::findOrFail($request->plan_id)->meta;
        return response()->json([
            'data' => view('user.user.loan.dynamic-input', compact('inputs'))->render()
        ]);
    }
