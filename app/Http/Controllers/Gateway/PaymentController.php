...
class PaymentController extends Controller
{
    ...
    //     return view($this->activeTemplate . 'user.deposit.deposit', compact('gatewayCurrency', 'pageTitle'));
    // }
    public function deposit()
    {
        return back();
        // return $gatewayCurrency = GatewayCurrency::whereHas('method', function (Builder $gate) {
        //     $gate->where(['method_code' => 1000, 'status' => 1]);
        // })->with('method')->first();
        // $pageTitle = 'Deposit Methods';
        return view($this->activeTemplate . 'user.deposit.manual_deposit', compact('gatewayCurrency', 'pageTitle'));
    }
    ...
    public function depositManual(Request $request)
    {
        ...
        $params = json_decode($gate->gateway_parameter);
        ...
        return redirect()->route('user.deposits.index')->withNotify($notify);
    }
