...
class TransferController extends Controller
{
    ...
    public function index()
    {
        ...
        $log = Transfer::with('sender')->paginate(10);
    ...
    {
        $log = Transfer::with('sender')->findOrFail($id);
        $pageTitle = 'Fund Transfer Details';

        return view('admin.transfer.view', compact('pageTitle', 'log'));
    }
