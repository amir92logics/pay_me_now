...
if (!function_exists('trx_type_int')) {

    /**
     * Get Trx Type Int Value
     *
...
function getTrx($length = 6, $prefix = '', $suffix = '')
{
...
function imagePath()
{
    ...
    $data['dashboardSlide'] = [
        'path' => 'assets/images/dashboardSlide',
    ];
    $data['favicon'] = [
        'size' => '128x128',
    ];
