        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.loan.plans.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-fw fa-plus"></i><i data-feather='plus-circle'></i> @lang('Add New')</a>
                </div>
                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.loan.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                        Edit
                                    </a>
                                </td>
                            </tr>
