...
@section('panel')
                ...
                <div class="table-responsive mb-3">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            @else
                            <td>{{ $loan->user_data[$data['field_name']] }}</td>
                            @endif
                        </tr>
                        @endforeach
                    </table>
            ...
            <div class="card">
                <div class="card-header align-items-start">
                    ...
                    @if ($loan->status == 1)
                        ...
                        <button type="button" data-bs-toggle="modal" data-bs-target="#inlineFormclose"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-bolder align-items-center">
                                                ...
                                                <span>{!! date(' D d, M Y', strtotime($loan->expire)) !!}<br><small>
                                                        {{ date('h:i A', strtotime($loan->created_at)) }}</small></span>
                                            </div>
                                        </td>
                                        <td class="text-nowrap">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="font-small-2 text-muted">Bal:
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card card-developer-meetup">
                <div class="meetup-img-wrapper rounded-top text-center">
                    <img src="{{ asset($activeTemplateTrue . 'app-assets/images/illustration/email.svg') }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">You are about to make payment for this running loan. Please
                        enter an amount below to service the loan</h4>
    ...
    <!-- Modal -->
    <div class="modal fade text-start" id="inlineFormclose" tabindex="-1" aria-labelledby="myModalLabel33"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">You are about to close this loan. This will terminate the
                        loan plan and mark this loan as comepleted</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
@push('script')
    <script>
        $(window).on("load", (function() {
            "use strict";
            var e, o, r, t, a, s, i, n, l, d, c, h, p = "#5e5873",
                w = "#ebe9f1",
                g = "#ebf0f7",
                u = "#b9b9c3",
            ...
            e = {
                ...
                series: [{{ @number_format($progress, 2) }}],
                stroke: {
                    lineCap: "round"
                },
                grid: {
                ...
                plotOptions: {
                    radar: {
                        polygons: {
                            strokeColors: [w, "transparent", "transparent", "transparent", "transparent",
                                "transparent"
                            ],
                ...
                colors: [window.colors.solid.primary, window.colors.solid.warning, window.colors.solid
                    .danger
                ]
            }, new ApexCharts(A, l).render(), d = {
                chart: {
                    type: "pie",
                    height: 325,
                    toolbar: {
