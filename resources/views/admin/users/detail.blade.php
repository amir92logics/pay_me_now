  ...
  <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
    ...
    <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
      <div class="card-body">
        ...
        <a href="{{ route('admin.users.login.history.single', $user->id) }}" class="btn btn-primary btn-sm btn-block btn-lg">
          @lang('Login Logs')
        </a>
        <a href="{{route('admin.users.email.single',$user->id)}}" class="btn btn-info btn-sm btn-block btn-lg">
          @lang('Send Email')
        </a>
          ...
          <div class="row">
            <div class="form-group col-xl-4 col-md-6  col-sm-3 col-12 mb-1">
              ...
              <div class="d-flex flex-column">
                ...
                <div class="form-check form-check-primary form-switch">
                  <input type="checkbox" name="status" @if($user->status) checked @endif class="form-check-input" id="customSwitch3" />
                </div>
              </div>
            ...
            <div class="form-group  col-xl-4 col-md-6  col-sm-3 col-12 mb-1">
              <div class="d-flex flex-column">
                ...
                <div class="form-check form-check-primary form-switch">
                  <input type="checkbox" name="ev" @if($user->ev) checked @endif class="form-check-input" id="customSwitch4" />
                </div>
              </div>
            ...
            <div class="form-group  col-xl-4 col-md-6  col-sm-3 col-12 mb-1">
              <div class="d-flex flex-column">
                ...
                <div class="form-check form-check-primary form-switch">
                  <input type="checkbox" name="sv" @if($user->sv) checked @endif class="form-check-input" id="customSwitch5" />
                </div>
              </div>
            ...
            <div class="form-group  col-md-6  col-sm-3 col-12">
              <div class="d-flex flex-column">
                ...
                <div class="form-check form-check-primary form-switch">
                  <input type="checkbox" name="ts" @if($user->ts) checked @endif class="form-check-input" id="customSwitch6" />
                </div>
              </div>
            ...
            <div class="form-group  col-md-6  col-sm-3 col-12">
              <div class="d-flex flex-column">
                ...
                <div class="form-check form-check-primary form-switch">
                  <input type="checkbox" name="tv" @if($user->tv) checked @endif class="form-check-input" id="customSwitch7" />
                </div>
              </div>
