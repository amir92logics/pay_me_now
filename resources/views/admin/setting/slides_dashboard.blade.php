        ...
        <div class=" mb-30">
            <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="avatar avatar-xl">
                                                    <img src="{{ getImage(imagePath()['dashboardSlide']['path'] . '/slide.png', '?' . time()) }}"
                                                        alt="avatar" />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="avatar-edit">
                                                <label for="profilePicUpload1" class="bg--primary">@lang('Select Image')
                                                </label>
                                                <input type="file" class="form-control profilePicUpload"
                                                    id="profilePicUpload1" accept=".png, .jpg, .jpeg" name="slide"
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="">
                                                <label class="form-label" >Enter image path </label>
                                                <input type="text" name="ramount" class="form-control"
                                                    placeholder="Example: http://demoimagepath.com" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <button type="submit" class="btn btn--primary text-white btn-block"
                    style="width: 10%; margin-bottom: 20px; margin-left: 20px;">@lang('Update')</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <a href="javascript:void(0)"
                        class="btn btn-sm btn--primary text-white box--shadow1 text--small addBtn waves-effect waves-float waves-light"><i
                                        ...
                                        <td data-label="@lang('Image')">
                                            <div class="customer-details d-block">
                                                <a href="javascript:void(0)" class="thumb">
                                                    <img src="{{ getImage(imagePath()['dashboardSlide']['path'] . '/' . $slide->path) }}"
                                                        width="50" alt="@lang('image')">
                                                </a>
                                            </div>
                                        </td>
                                        <td data-label="@lang('Action')">
                                            <button class="btn btn-sm text-white updateBtn" data-id="{{ $slide->id }}"
                                                data-all="">
                                                Edit
                                            </button>
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-1">
                            ...
                            <div class="image-upload">
                                <div class="thumb">
                                    <div class="avatar-edit">
                                        <input type="file" class="profilePicUpload" name="image" id="addImage"
                                            accept=".png, .jpg, .jpeg">
