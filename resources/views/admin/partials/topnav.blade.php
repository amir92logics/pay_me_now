    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    <li class="dropdown-menu-header">
                        <div class="dropdown-header d-flex">
                            ...
                            @if ($adminNotifications->count() > 0)
                                <div class="badge rounded-pill bg-danger">{{ $adminNotifications->count() }}
                                    New</div>
                            @endif
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    id="dropdown-user" href="index.html#" data-bs-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span
                            class="user-name fw-bolder  text-white">{{ auth()->guard('admin')->user()->username }}</span><span
                            class="user-status  text-white">Admin</span></div><span class="avatar"><img class="round"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.password') }}"><i class="me-50"
                            data-feather="lock"></i> @lang('Password')</a>
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('admin.logout') }}"><i
                            class="me-50" data-feather="power"></i> @lang('Logout')</a>
                </div>
            </li>
        </ul>
    </div>
