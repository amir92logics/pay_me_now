                                ...
                                <div class="thumb">
                                    ...
                                    <div class="input-group mb-1 d-flex flex-wrap justify-content-end has_append width-375">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn text-white btn--primary newCurrencyBtn"
                                                    ...
                                                    <div class="input-group-append">
                                                        <div class="input-group-text">
                                                            <span class="copyInput" data-toggle="tooltip"
                                                                title="@lang('Copy')"><i class="fa fa-copy"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="payment-method-item child--item">
                                    <div class="payment-method-header">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" name="currency[{{ $currencyIdx }}][image]"
                                                    id="image{{ $currencyIdx }}" class="profilePicUpload form-control"
                                                    accept=".png, .jpg, .jpeg" />
                                        ...
                                        <div class="remove-btn">
                                            <button type="button" class="btn  text-white btn-danger deleteBtn"
                                ...
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        <input disabled type="file" accept=".png, .jpg, .jpeg"
                                            class="form-control profilePicUpload" id="image{{ $currencyIdx }}"
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-1">
                                                    ...
                                                    <input disabled type="text" class="form-control"
                                                        name="currency[{{ $currencyIdx }}][min_amount]" placeholder="0"
                                                        required />
                                                </div>
...
@push('breadcrumb-top-right')
    <a href="{{ route('admin.gateway.automatic.index') }}" class="btn btn-sm btn--primary text-light box--shadow1 text--small"> @lang('Go Back') <i data-feather='fast-forward'></i></a>
@endpush
