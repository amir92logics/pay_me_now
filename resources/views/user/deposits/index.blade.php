    ...
    <div class="col-md-12">
        <div class="card b-radius--10">
            <div class="card-header justify-content-between py-1">
                <div class="col">
                    <a class="btn btn-primary btn-sm" href="{{ route('user.deposits.create') }}">{{ __('Make Deposit') }}
                        ...
                        <tbody>
                            @forelse($deposits as $deposit)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.deposits.show', $deposit->id) }}" class="btn btn-primary btn-sm"> <i data-feather='eye'></i> {{ __('View') }}</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
