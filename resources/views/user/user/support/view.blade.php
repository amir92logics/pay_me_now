...
<section class="chat-app-window">
  ...
  <div class="active-chat">
      ...
      <header class="chat-header">
        <div class="d-flex align-items-center">
          ...
          <div class="avatar avatar-border user-profile-toggle m-0 me-1">
            <img src="{{ @getImage(imagePath()['profile']['user']['path'].'/'. $user->image,imagePath()['profile']['user']['size']) }}" alt="avatar" height="36" width="36" />
    ...
    <div class="user-chats">
      <div class="chats">
        ...
        <div class="chat chat-left">
          <div class="chat-avatar">
            <span class="avatar box-shadow-1 cursor-pointer">
              <img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="avatar" height="36" width="36" />
            </span>
          </div>
          <div class="chat-body">
            <div class="chat-content">
    ...
    @csrf
      ...
      <span class="speech-to-text input-group-text bg-info">
        <a href="tel:08023444323"><i class="text-white" data-feather="phone-call" class="cursor-pointer"></i>
        </a>
        <input type="hidden" name="replayTicket" value="1">

      </span>
      <input type="text" required name="message" class="form-control" placeholder="Type your message or give us a call" />
      <span class="input-group-text bg-primary">
        <label for="attach-doc" class="attachment-icon form-label mb-0">
          <i data-feather="image" class="cursor-pointer text-white"></i>
