                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header py-3 d-flex justify-content-between bg-transparent align-items-center flex-wrap border-bottom">
                                    <h6 class="mb-0 fw-bold">Buy {{$coin->name}}</h6><br>
                                    <ul class="nav nav-tabs tab-body-header rounded d-inline-flex mt-2 mt-md-0" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#Limit" role="tab">BUY</a></li>
                                                        ...
                                                        <div class="row g-3 mb-3">
                                                            <div class="col-xl-12">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input name="buy" value="buy" hidden>
                                                            ...
                                                            <div class="d-flex flex-wrap justify-content-between mb-1">
                                                                ...
                                                                <div class="d-flex flex-wrap justify-content-between mb-1">
                                                                    <div>Our Price</div>
                                                                    <div class="text-muted"> 1 {{$coin->symbol}} = {{number_format($coin->sell,2)}} {{$general->cur_text}}</div>
                                                                </div> 
                                                                <div class="d-flex flex-wrap justify-content-between mb-1">
                                                                    <div>Inverse Price</div>
                                                                    <div class="text-muted"> 1 USD = {{number_format(1/$coin->sell,8)}} {{$coin->symbol}}</div>
                                                                </div>
                                                                </b>
                                                                <hr>
                                                               ...
                                                               <b><div class="d-flex flex-wrap justify-content-between">
                                                                ...
                                                                <div class="d-flex flex-wrap justify-content-between">
                                                                    ...
                                                                    <div class="text-success" id="toget"> 0.00000 {{$coin->symbol}}</div>
                                                                </div>
                                                                </b> 
                                                            </div>
                                                        </div>
                                                        <button type="submit" class="btn flex-fill btn-light-primary btn-block py-2 fs-5 text-white px-5">Place Order</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="Market">
                                            ...
                                            <table  class="myProjectTable table table-hover custom-table align-middle mb-0" style="width:100%">
                                                ...
                                                @foreach($buys as $data)
                                                    <tr>
                                                        <td><img src="{{url('/')}}/assets/images/coins/{{$coin->image}}" alt="" width="50" class="img-fluid avatar mx-1"> <span class="text-muted">{{$coin->symbol}}</span></td>
                                                        ...
                                                        <td><small class="color-price-up">{{number_format($data->get_fiat,2)}}<small>{{$general->cur_text}}</small> / {{number_format($data->get_coin,2)}}{{$coin->symbol}}</small></td>
