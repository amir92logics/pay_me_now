                    ...
                    <div class="card card-congratulations">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('user.transfers.index') }}" class="btn btn-relief-success d-block d-sm-inline-block mt-1 mt-lg-0">
                                ...
                                {{-- <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="font-weight-bold text-start text-primary"><b>{{ __('Quick Links') }}</b></h4>
                    ...
                    <div class="row match-height">
                        <div class="col-lg-12 col-md-6 col-12">
                            <div class="bg-transparent card earnings-card shadow-none">
                                <div class="row">
                                    <div class="col-12">
                                        <img class="img-fluid" src="{{ getImage(imagePath()['dashboardSlide']['path'] . '/slide.png') }}" height="110" alt="logo">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-primary alert-dismissible fade show p-1" role="alert">
                                    <i data-feather="star" class="me-50"></i>
                                    <span> {{ $general->news }}</span>
                                    <button type="button" class="btn-close news-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="card card-primary">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                <small>@lang('Total Available Balance')</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-end">
                                    <a href="{{ route('user.deposits.index') }}" class="btn btn-primary btn-sm text-end mt-1">{{ __('Deposit') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body mb-1 text-center">
                            <a class="btn btn-primary btn-sm mt-1" href="{{ route('user.transfers.index') }}">{{ __('Send Fund') }} <i data-feather='arrow-right'></i></a>
                            <a class="btn btn-primary btn-sm mt-1" href="{{ route('user.withdraw-methods.index') }}">{{ __('Cash Out') }} <i data-feather='credit-card'></i></a>
                            <a class="btn btn-primary btn-sm mt-1" href="">{{ __('Bill Pay') }} <i data-feather='dollar-sign'></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row match-height">
                ...
                <div class="col-12">
                    <div class="alert alert-light alert-dismissible fade show p-1" role="alert">
                        ...
                        <button type="button" class="btn-close text-light ads-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif
                ...
                <div class="col-lg-12 mb-1">
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            @forelse($dashboardSlides as $dashboardSlide)
                                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                    <img height="200" src="{{ getImage(imagePath()['dashboardSlide']['path'] . '/' . $dashboardSlide->path) }}"
                                        class="d-block w-100 bg-white" alt="logo">
                                </div>
                            @empty
                            @endforelse
            ...
            <div class="">
                @forelse ($dashboardFooter as $element)
                    @if ($element->data_type == 'element.textlink')
                        <a class="btn-flat-primary" target="_blank"
                            href="{{ $element->data_text2 }}">{{ $element->data_text }}</a> &nbsp;
