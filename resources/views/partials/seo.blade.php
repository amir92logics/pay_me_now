@if($seo)
    <meta name="title" Content="{{ $general->sitename(__($pageTitle ?? env('APP_NAME'))) }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $general->sitename($pageTitle ?? env('APP_NAME')) }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ $general->sitename($pageTitle ?? env('APP_NAME')) }}">
